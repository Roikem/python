$(function(){
    ...
    $('#add_form').click(function(){
        ...
        $("#submit").click(function(){
            ...
            data['object1'] = $('.form2').val();
            data['contact'] = $('.form3').val();
            data['num'] = $('.form4').val();
            data['price'] = $('.form5').val();
            data['place'] = $('.form6').val();
            $.ajax({
                url:'/command/',
                type:'POST',
                data: {
    ...
    function get_market(){
        $.getJSON('/get_market/',function(data){
            var u_name = [];
            ...
            for(var i =0; i< parseInt(data['list_length']); i++ ) {
                ...
                forms.children(".2").children().text(u_name[i].object1);
                ...
                forms.children(".6").children().text(u_name[i].place);
